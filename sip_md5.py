...
class sipDigest():
    ...
    #Constructor
    def __init__(self, nonce, nonceCount, realm, cnonce, qop, algorithm, password, username, entitybody):
...
if __name__ == '__main__':
    ...
    _CLI_INV_ARGS = "\nInvalid commandline arguments!   Arguments should be: nonce nonceCount realm cnonce qop algorithm password username entitybody\n\n\
Example: filename    nonce    ncount         digest realm         cnonce   qop  algorithm  password  username  entity body\n\
         -----------------------------------------------------------------------------------------------------------------\n\
command: sip_md5.py 34000dfg 00000001 sip:hpbx.appiaservices.com ytedf745h auth    MD5     password 7001234567 EntityBody\n\
